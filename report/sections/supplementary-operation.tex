...
\begin{figure}[h]
    ...
    \caption{Operation of batteries at 40 TWh export, style adapted from cf. \cite{Neumann2022}}
...
\begin{figure*}[h] % Use 'figure*' to span both columns
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{graphics/integrated_comp/contour_ft_cf_20_filterTrue.pdf}
