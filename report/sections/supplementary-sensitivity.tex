...
\begin{figure*}[h] % Use 'figure*' to span both columns
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../\sensbattery/graphics/integrated_comp/contour_lcoe_w_20_filterTrue.pdf}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../\sensbattery/graphics/integrated_comp/contour_lcoh_w_mixed_20_filterTrue.pdf}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../\sensbattery/graphics/integrated_comp/contour_lcoe_w_no_electrolysis_20_filterTrue.pdf}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../\sensbattery/graphics/integrated_comp/contour_lcoe_w_electrolysis_20_filterTrue.pdf}
...
\begin{figure*}[h] 
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../\sensbattery/graphics/integrated_comp/contour_cf_electrolysis_20_filterTrue.pdf}
...
\begin{figure*}[h] % Use 'figure*' to span both columns
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../\sensbattery/graphics/integrated_comp/contour_curtailmentrate_solar_20_filterTrue.pdf}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../\sensbattery/graphics/integrated_comp/contour_curtailmentrate_wind_20_filterTrue.pdf}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../\sensbattery/graphics/integrated_comp/contour_Battery_GWh_20_filterTrue.pdf}
    ...
    \begin{subfigure}[b]{0.45\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../\sensbattery/graphics/integrated_comp/contour_H2_GWh_20_filterTrue.pdf}
