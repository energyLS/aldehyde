...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \hfill    
    \caption{Relative change of electricity (Fig. \ref{fig:expenses-relative-120-elec}) and hydrogen consumer cost (Fig. \ref{fig:expenses-relative-120-hy}) depending on the temporal hydrogen regulation.     
