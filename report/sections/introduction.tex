...
%\begin{itemize}
%    \item domestic energy demand considered in: MenaFuels and \cite{Hampp2023}. According to MenaFuels the domestic demand is usually just some percentages of the potential
%    \item Hydrogen from (North-)Africa (to Europe): \cite{vanWijk2021} \cite{AbouSeada2022} \cite{vanderZwaan2021} and \cite{Schellekens2010} and \cite{Cavana2021}, specific countries from Africa: \cite{Hampp2023}, PV technologies for Hydrogen production in Africa \cite{Touili2022}, Pipeline blend \cite{Timmerberg2019a}, hydrogen cost \cite{Sens2022}
