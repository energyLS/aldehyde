...
Numerous studies focus exclusively on either hydrogen exports or domestic climate mitigation ambitions, without discussing the complex relationship between these two dimensions. These studies miss interactions between on-grid hydrogen electrolysis and the domestic electricity system, fail to uncover potential synergies and conflicts for both hydrogen exporters as well as domestic electricity consumers.

% Third: Task
To investigate interactions between hydrogen exports and domestic mitigation, this research paper presents a fully sector-coupled capacity expansion and dispatch model of Morocco, which includes both gas pipelines and electricity networks.
% Conflicts and synergies between both objectives are assessed based on electricity prices/expenses for domestic consumers and hydrogen prices/expenses for exporters.
