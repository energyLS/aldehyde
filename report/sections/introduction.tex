...
% Forth: Task
Here, we show the potential impact of hydrogen exports on domestic electricity consumers and, vice versa, interactions of domestic \co mitigation on hydrogen exporters. Under various hydrogen export volumes, climate targets and temporal matchings, we demonstrate the effects of temporal hydrogen regulation on benefits for hydrogen exporters and domestic electricity consumers. This study presents a fully sector-coupled capacity expansion and dispatch model of Morocco, which includes both gas pipelines and electricity networks. The model assumes a fully liberalized market structure, the possible implications of which are discussed in the Chapter \nameref{sec:discussion}.
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{../graphics_general/policy/mar_hydrogen_strategy_semistacked.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\linewidth]{../graphics_general/morocco_em.pdf}
