\tocbigheading{Supplementary Discussion 2: Hydrogen cost breakdown}
\label{subsec:electrolysis_op_comp}

The endogenous price of hydrogen depends on single cost components as well as the temporal hydrogen regulation. Supplementary Fig. \ref{fig:costbreakdown_hourly} displays the cost breakdown of hydrogen 
whereas the combined cost in the Supplementary Fig. \ref{fig:hydrogen-cost-hourly} differs from the price of hydrogen in the Supplementary Fig. \ref{fig:hydrogen-price-hourly}. This is due to the temporal hydrogen regulation, the costs for the required installation of additional renewable electricity capacities are not reflected in the cost breakdown but included in the price of hydrogen. This effect is most striking in high export and low domestic \co mitigation scenarios. 
In constrast, if there is no temporal hydrogen regulation applied, both hydrogen cost (see Supplementary Fig. \ref{fig:hydrogen-cost-norule}) and hydrogen price (see Supplementary Fig. \ref{fig:hydrogen-price-norule}) show similar trends across all domestic \co mitigation and export scenarios.
