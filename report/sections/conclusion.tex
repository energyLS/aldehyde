...
to protect local consumers. Hourly matching decreases the expenses for domestic electricity (up to -31\%) and increases expenses for hydrogen exports (up to 7\%) in high export and low mitigation scenarios. Hydrogen regulation can effectively hedge domestic electricity consumers against rising prices across mitigation and export scenarios. %Furthermore, these redistribution effects are less pronounced in countries with a high share of renewable electricity.
