...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{../graphics_general/first_results/Export-only-land-use-solar.pdf}
        \caption{Low export}
        \label{fig:graphic1}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{../graphics_general/first_results/Export-only-high-land-use-solar.pdf}
        \caption{High export}
        \label{fig:graphic2}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=\textwidth]{../graphics_general/first_results/MAR-ES-only-land-use-solar.pdf}
        \caption{MAR-ES only}
        \label{fig:graphic3}
    \end{subfigure}
