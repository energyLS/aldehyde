...
% Hourly matching decreases the cost for domestic electricity (up to -31\%) and increases cost for hydrogen exports (up to 7\%) in high export and low climate change mitigation scenarios.
% Our analysis across all three dimensions (export, climate change mitigation, hydrogen regulation) shows the importance of strong hydrogen regulation in high export and low climate change mitigation scenarios beyond the specific case of Morocco. 
