...
\begin{figure*}[h!] % Use 'figure*' to span both columns
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../../workflow/subworkflows/pypsa-earth-sec/results/\runcarbonmgmt/graphs/balances-co2.pdf}
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        \centering
        \includegraphics[width=\linewidth]{../../workflow/subworkflows/pypsa-earth-sec/results/\runcarbonmgmt/graphs/balances-co2_stored.pdf}
