...
Temporal matching increases hydrogen prices (s. Fig. \ref{fig:marginal_prices_hy_gh_sens}) and decreases electricity prices (s. Fig. \ref{fig:marginal_prices_el_gh_sens}) especially in low climate change mitigation and high export scenarios.
