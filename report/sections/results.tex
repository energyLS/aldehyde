...
\begin{figure}[h!]
    \centering
    \includegraphics[trim={0cm 0cm 0cm 1cm}, clip, width=\linewidth]{../../workflow/subworkflows/pypsa-earth-sec/results/\runstandard/co2l2.0-only/graphs/balances-AC.pdf}
...
\begin{itemize}
    \item Local electricity consumers and hydrogen exports do not both profit, but 
