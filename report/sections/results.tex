...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        ...
        \caption{Relative cost of local electricity customers (normalized to 1 TWh hydrogen export)}
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        ...
        \caption{Relative cost of hydrogen exporters (normalized to 0\% \co reduction)}
...
First, Figure \ref{fig:expense_ac} shows the cost for domestic electricity consumers subject to mitigation and hydrogen export volumes. The costs are normalized to costs at 1 TWh Hydrogen export at each mitigation level, displaying relative changes for domestic electricity consumers induced by hydrogen exports at a certain mitigation.
...
The only increase of cost induced by hydrogen exports is observable at a low mitigation of 10\% and exports of 20 TWh. (TODO: explain why).


Second, Figure \ref{fig:expense_h2} shows the cost of hydrogen exports subject to mitigation and hydrogen export volumes. The costs are normalized to costs at 0\% mitigation at each hydrogen export volume, displaying relative changes for hydrogen exports from domestic mitigation at a certain hydrogen export volume.
...
This cost increase results from lower electrolysis capacity factors compared to the 0\% mitigation scenario, where we observe high electrolysis capacity factors of above 80\% (s. Fig. \ref{fig:ely-cf}) (TODO: elabore reason).
...
Figure \ref{fig:expenses_real_120} shows the relative change of electricity and hydrogen cost of all domestic mitigation (0--100\%) and hydrogen export (0--200 TWh) scenarios in dependence of temporal matching. 
