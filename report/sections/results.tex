...
The electricity supply at increasing hydrogen exports is displayed in Figure \ref{fig:balances-ac-co2l20}. The deployment of hydrogen exports requires a scale up of onshore wind and solar PV accordingly, as defined by the green hydrogen constraint (\ref{subsec:green_hydrogen_constraint}).
...
% - Ref to supplementary and the effect of green hydrogen constraint -> Role of storage here? -> New run without gh constraint and check storage
