...
\subsection{PUNCH 1: Benefits of local decarbonisation and hydrogen export}
...
\subsection{PUNCH 2: Benefits for local electricity consumers and hydrogen exporters depend on the green hydrogen regulation}
...
\begin{itemize}
    ...
    \item Figure \ref{fig:expense_rule}
\end{itemize}
...
\subsection{PUNCH 3: Green hydrogen regulation hedges local electricity consumers against rising prices}
\label{subsec:rule_regulates}
