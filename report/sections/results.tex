...
\begin{itemize}
    ...
    \item Strict hydrogen regulation has strong effects on electricity system dispatch (and emission factor), increasing the prices/expenses for hydrogen exporters whilst decreasing for domestic electricity consumers
\end{itemize}

Graph/Main:
\begin{itemize}
    \item Energy spillover I: Stricter hydrogen regulation requires additional renewable capacities (\& hydrogen storage, see appendix) to meet the electricity demand of electrolysis on an annual/monthly/hourly basis. These capacities provide excess electricity to the domestic electricity system (s. Fig. \ref{fig:dispatch_rule})
    \item Energy spillover II:
    \item Price spillover: (Appendix)
...
Punch:
\begin{itemize}
    \item Strict hydrogen regulation decarbonizes hydrogen and domestic electricity demand
    \item Strict hydrogen regulation decreases expenses for domestic electricity and increases for H2 exports
\end{itemize}
