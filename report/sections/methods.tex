...
\begin{enumerate}
    \item the (energy and non-energy) emission reduction between 0 - 100\% based on Morocco's current emissions of 72 Mt\coe (s. Sec. \ref{subsec:policyandtargets}) and
    \item The hydrogen export volume varies from 0 - 200 TWh, going beyond Moroccos hydrogen export ambitions of 114.7~TWh (s. Sec. \ref{subsec:policyandtargets}).
\end{enumerate}
This two-dimensional scenario space leads to 121 model runs. 
