...
In the case of low domestic climate change mitigation, a low BEV share results in a high fuel demand for e.g. Internal Combustion Engine Cars, as observable in Figure \ref{fig:tsc-120-0}. This reflects a constant energy service demand (transportation) while the primary energy is subject to climate change mitigation.
