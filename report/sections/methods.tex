...
In a first step, the annual energy demand is obtained from \cite{unstats2023}. The latest available data is from 2020, since these energy balances are likely to show irregularities due to COVID-19 implications, the base year in this study is 2019. Based on the annual energy demand from 2019, the energy demand of 2035 is projected according to efficiency gains and activity growth rates similar to \cite{Mueller2023}.
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.7\linewidth]{../graphics_general/MAR_brownfield_el.png}
...
The conventional electricity generators are obtained from the \textit{powerplantmatching} tool \cite{Powerplantmatching2019}. \textit{Powerplantmatching} uses various input sources as OpenStreetMap, Global Energy Monitor, IRENA \cite{IRENA2022, OpenStreetMap, GlobalEnergyMonitor} to download, filter and merge the datasets. 
