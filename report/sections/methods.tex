...
%     \item Oversize water desalination to provide water for domestic population/agriculture to increase public acceptance
...
% In the islanded hydrogen production scenario, the hydrogen production is optimised without considering the domestic energy system described in \ref{subsec:moroccan_model}.
