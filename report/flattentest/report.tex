...
\begin{frontmatter}
	...
	% \author[oth,tub]{Leon~Schumm\corref{correspondingauthor}}
	% \author[oth,tub]{Leon~Schumm${}^{1,2*}$}
	...
	\address[oth]{${}^1$ Research Center on Energy Transmission and Storage (FENES), Faculty of Electrical and Information Technology, University of Applied Sciences (OTH) Regensburg, Seybothstr. 2, 93053 Regensburg, Germany. \textit{* Corresponding author: leon1.schumm@oth-regensburg.de}}
	...
	\address[corrauth]{* Corresponding author. Email: leon1.schumm@oth-regensburg.de}
...
Temporal matching in selected European countries is investigated in Zeyen et al.\cite{Zeyen2024}, whereas Ruhnau et al.\cite{Ruhnau2023} points out the effect of relaxing simultaneity requirements of RE supply and hydrogen generation on project design, economics, and power sector emissions.
...
While mitigation targets can (in part) be met with technologies like fossil gas with CCS or Direct Air Capture, the model finds that increasing renewable capacities, particularly solar PV and wind, is the most cost-effective solution (s. Fig. \ref{fig:balances-ac}). As mitigation efforts intensify, renewables become the cost-optimal choice for decarbonizing the energy system due to their cost-competitiveness and large-scale availability.
...
In an integrated analysis of domestic \co mitigation (dimension 1) and hydrogen exports (dimension 2) this study outlines that both domestic \co mitigation and hydrogen exports profit from each other and show co-benefits. In this section, we i) show the effects of hydrogen exports on market-based costs for domestic electricity consumers, ii) the role of domestic \co mitigation on hydrogen export cost, and lastly iii) common co-benefits.

First, Figure \ref{fig:expense_ac_120} illustrates how domestic electricity consumers benefit from a stronger hydrogen export industry at different decarbonization targets. The costs are normalized to the cost level at 1 TWh hydrogen export for each domestic \co mitigation level, showing the relative impact of hydrogen exports on domestic electricity costs. Negative values indicate that hydrogen exports reduce average market-based electricity costs for domestic consumers.
...
This cost reduction is driven by improvements in system flexibility -- such as BEV charging, energy storage, and expanded transmission capacities (s. Fig. \ref{fig:balances-ac}) -- which also benefit hydrogen exporters.
...
In only two scenarios, hourly matching regulation increases the hydrogen cost above 7\% (above 11\% across all groups) compared to no temporal hydrogen regulation. This is the case for 0\% \co mitigation and 1 and 20 TWhxport scenarios. 
...
The amount of hydrogen to be exported or further synthesized for export is  implemented as an exogenous parameter in the range of 0-120~TWh, with sensitivity analysis up to 200 TWh presented in the Supplementary Discussion 3: High export sensitivity.
...
\newblock \emph{\bibinfo{journal}{Science}} \textbf{\bibinfo{volume}{360}},
  \bibinfo{pages}{eaas9793} (\bibinfo{year}{2018}).
...
\newblock \bibinfo{title}{Net zero by 2050. {{A}} roadmap for {{theGlobal}}
  energy sector}.
...
\newblock \bibinfo{title}{Moving towards 100{\textbackslash}\% renewable
  electricity in {{Europe}} {\textbackslash}\& {{North Africa}} by 2050}.
...
\newblock \bibinfo{title}{Benefits of a hydrogen network in europe}.
\newblock \emph{\bibinfo{journal}{SSRN Electronic Journal}}
  (\bibinfo{year}{2022}).
...
\bibitem{Verpoort2023}
\bibinfo{author}{Verpoort, P.~C.}, \bibinfo{author}{Gast, L.},
  \bibinfo{author}{Hofmann, A.} \& \bibinfo{author}{Ueckerdt, F.}
\newblock \bibinfo{title}{Estimating the renewables pull in future global green
  value chains}  (\bibinfo{year}{2023}).

\bibitem{DEA2019TechnologyData}
\bibinfo{author}{{Danish Energy Agency (DEA)}}.
\newblock \bibinfo{title}{Technology data} (\bibinfo{year}{2019}).
\newblock
  \urlprefix\url{https://ens.dk/en/our-services/projections-and-models/technology-data}.
...
\bibinfo{author}{Neumann, F.}, \bibinfo{author}{Hampp, J.} \&
  \bibinfo{author}{Brown, T.}
\newblock \bibinfo{title}{Energy {{Imports}} and {{Infrastructure}} in a
  {{Carbon-Neutral European Energy System}}} (\bibinfo{year}{2024}).
\newblock \urlprefix\url{http://arxiv.org/abs/2404.03927}.
\newblock \eprint{2404.03927}.
...
\newblock \urlprefix\url{http://arxiv.org/abs/2207.05816}.
...
\newblock \bibinfo{title}{Ranking the {{World}}'s {{Most Water-Stressed
  Countries}} in 2040} (\bibinfo{year}{Wed, 08/26/2015 - 00:01}).
\newblock
...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        \centering
        \includegraphics[trim={0cm 0cm 0cm 1cm}, clip, width=\linewidth]{fig3.pdf}
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        \centering
        \includegraphics[trim={0cm 0cm 0cm 1cm}, clip, width=\linewidth]{fig4.pdf}
        \caption{Fixed (0\%) domestic \co mitigation and 1--120 TWh export}
    ...
    See Supplementary Fig. \ref{fig:balances-ac-noreg} for electricity supply and demand if no hydrogen regulation is in place and Supplementary Fig. \ref{fig:balances-ac-200} for hydrogen exports up to 200 TWh.
    }
...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        ...
        Relative cost of electricity for domestic consumers (normalized to 1 TWh hydrogen export)}
    ...
    Figure \ref{fig:expense_ac_120} shows the effect of hydrogen ({H${}_2${}}) exports on domestic electricity cost with hourly hydrogen regulation. Therefore, the effect of hydrogen exports is isolated by normalizing the costs to 1 TWh hydrogen export in each column. This approach allows for a vertical interpretation in Figure \ref{fig:expense_ac_120} only, displaying the effects of hydrogen exports (vertical) at a certain domestic \co mitigation level.
...
\begin{figure}[h!]
    \centering
    \includegraphics[trim={0cm 0cm 0cm 0.65cm}, clip, width=0.7\linewidth]{fig7.0_Hours.pdf}
    \caption{
...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        \centering
        \includegraphics[trim={0cm 0cm 0cm 0.65cm}, clip, width=\linewidth]{fig8.0.pdf}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        \centering
        \includegraphics[trim={0cm 0cm 0cm 0cm}, clip, width=\linewidth]{fig10.pdf}
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        \centering
        \includegraphics[trim={0cm 0cm 0cm 0cm}, clip, width=\linewidth]{fig11.pdf}
