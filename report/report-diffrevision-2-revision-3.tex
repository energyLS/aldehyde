...
%DIF ADD ./latexdiff-vc-revision-3/report.tex   Wed Jun 18 10:26:03 2025
...
\begin{figure}[h!]
    ...
    Violin plots indicate median (white dot), interquartile range (thick black bar), and 1.5x interquartile range (thin black bar), using kernel density estimation to show the distribution shape of the mitigation-export scenarios, grouped into \DIFdelbeginFL \DIFdelFL{different speeds of transformation }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{three stylized transition strategies }\DIFaddendFL (1\DIFdelbeginFL \DIFdelFL{,2,}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{–}\DIFaddendFL 3) \DIFaddbeginFL \DIFaddFL{reflecting different sequences of export and mitigation ambition}\DIFaddendFL .
