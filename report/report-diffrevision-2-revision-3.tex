...
%DIF DEL ./latexdiff-vc-revision-2/report.tex   Wed Feb 19 10:34:17 2025
%DIF ADD ./latexdiff-vc-revision-3/report.tex   Tue Jun 24 10:39:11 2025
...
We find substantial co-benefits of domestic carbon dioxide mitigation and hydrogen exports, whereby exports can reduce \DIFaddbegin \DIFadd{market-based }\DIFaddend costs for domestic electricity consumers while mitigation reduces costs for hydrogen exporters.
However, increasing hydrogen exports in a fossil-dominated system can substantially raise \DIFaddbegin \DIFadd{market-based }\DIFaddend costs for domestic electricity consumers, but surprisingly, temporal matching of hydrogen production can lower these costs by up to 31\% with minimal impact on exporters.
...
\cite{vanWijk2021, AbouSeada2022, vanderZwaan2021, Schellekens2010, Cavana2021, Touili2022, Timmerberg2019, Sens2022, Franzmann2023} }\hspace{0pt}%DIFAUXCMD
...
Temporal matching in selected European countries is investigated in Zeyen et al.\cite{Zeyen2024}, whereas Ruhnau et al.\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{Ruhnau2023a} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{Ruhnau2023} }\hspace{0pt}%DIFAUXCMD
}\DIFaddend points out the effect of relaxing simultaneity requirements of RE supply and hydrogen generation on project design, economics, and power sector emissions.
...
\DIFaddbegin \DIFadd{While our model is static, the scenario design allows exploration of different sequences in export and mitigation ambition.
}\DIFaddend 
...
% Forth: Task
Here, we show the substantial co-benefits of domestic carbon dioxide mitigation and hydrogen exports, whereby exports can reduce \DIFaddbegin \DIFadd{market-based }\DIFaddend costs for domestic electricity consumers while mitigation reduces costs for hydrogen exporters.
Under various hydrogen export volumes, climate targets and temporal matchings, we demonstrate 
that temporal hydrogen regulation can lower the \DIFaddbegin \DIFadd{market-based }\DIFaddend costs for domestic electricity consumers by up to 31\% with minimal impact on exporters.
...
\DIFdelbegin \DIFdel{The model assumes a central planner’s perspective, with the results being equivalent to a decentral market solution under the conditions outlined in the section }%DIFDELCMD < \nameref{sec:discussion}%%%
\DIFdel{.
}\DIFdelend %DIF >  The model assumes a central planner’s perspective, with the results being equivalent to a decentral market solution under the conditions outlined in the section \nameref{sec:discussion}.
We use costs referring to model inputs and system costs, while prices denote endogenous shadow prices (representing idealized market prices) derived from the model. Payments made by consumers (calculated as energy price times energy volume) are described as \DIFaddbegin \DIFadd{market-based }\DIFaddend (consumer) costs \DIFaddbegin \DIFadd{based on idealized market prices }\DIFaddend or, alternatively, (consumer) payments to highlight their financial impact. 
\DIFaddbegin \DIFadd{These payments only translate into one component of consumer electricity bills if whole-sale electricity prices are passed through to the retail tariff. Additional components in retail electricity prices depend on region-specific regulation and are not included here.
}\DIFaddend 
...
In an integrated analysis of domestic \co mitigation (dimension 1) and hydrogen exports (dimension 2) this study outlines that both domestic \co mitigation and hydrogen exports profit from each other and show co-benefits. In this section, we i) show the effects of hydrogen exports on \DIFdelbegin \DIFdel{cost }\DIFdelend \DIFaddbegin \DIFadd{market-based costs }\DIFaddend for domestic electricity consumers, ii) the role of domestic \co mitigation on hydrogen export cost, and lastly iii) common co-benefits.

First, Figure \ref{fig:expense_ac_120} illustrates how domestic electricity consumers benefit from a stronger hydrogen export industry at different decarbonization targets. The costs are normalized to the cost level at 1 TWh/a hydrogen export for each domestic \co mitigation level, showing the relative impact of hydrogen exports on domestic electricity costs. Negative values indicate that hydrogen exports reduce average \DIFaddbegin \DIFadd{market-based }\DIFaddend electricity costs for domestic consumers.
Figure \ref{fig:expense_ac_120} shows, that hydrogen exports decrease the relative domestic electricity costs by up to 45\%, especially at mitigation levels below 40\% and exports above 50 TWh. 
...
This cost reduction is driven by improvements in system flexibility -- such as BEV charging, energy storage, and expanded transmission capacities (s. Fig. \ref{fig:balances-ac-0exp-120}) -- which also benefit hydrogen exporters.
...
as shown in Figure \ref{fig:expense_h2_120} and in the sensitivity analysis for higher exports in Supplementary Fig. \ref{fig:expense_h2_200}. 
...
The top-left region of Figure \ref{fig:expense_h2_120} indicates that at certain export levels, hydrogen export costs become largely independent of domestic \co mitigation. This is driven by temporal hydrogen regulation further investigated in the section on \nameref{subsec:benefits_rule}. Here, hydrogen export infrastructure decouples from the domestic electricity system, the cost is increasingly independent of domestic \co mitigation.
When hydrogen exports reach twice the size of domestic electricity demand (s. Fig. \ref{fig:expense_h2_120}), the influence of the domestic electricity system on hydrogen export costs becomes negligible.
...
%%% SELECTION
%DIF >  Based on the effects of temporal hydrogen regulation in the scenario of 120 TWh/a export and 0\% \co mitigation presented in the previous section, this section explores the temporal hydrogen regulation across all mitigation (0--100\%) and export (0-120 TWh/a) scenarios. We have grouped these scenarios into three illustrative mitigation-export pathways presenting various speeds of transformation. They consist of 
%DIF >  (i) Quick exports and slow \co mitigation,
%DIF >  (ii) Balanced exports and \co mitigation and
%DIF >  (iii) Slow exports and quick \co mitigation as further elaborated in Supplementary Fig. \ref{fig:scenario-sel-120}.
\DIFaddbegin 

\DIFaddend Based on the effects of temporal hydrogen regulation in the scenario \DIFdelbegin \DIFdel{of }\DIFdelend \DIFaddbegin \DIFadd{with }\DIFaddend 120 TWh/a \DIFdelbegin \DIFdel{export }\DIFdelend \DIFaddbegin \DIFadd{exports }\DIFaddend and 0\% \co mitigation presented in the previous section, \DIFdelbegin \DIFdel{this section explores the temporal hydrogen regulation across all mitigation (0--100}\DIFdelend \DIFaddbegin \DIFadd{we now broaden the analysis to the full scenario space of mitigation (0–100}\DIFaddend \%) and export \DIFdelbegin \DIFdel{(0-120 }\DIFdelend \DIFaddbegin \DIFadd{levels (0–120 }\DIFaddend TWh/a)\DIFdelbegin \DIFdel{scenarios.
We have grouped these }\DIFdelend \DIFaddbegin \DIFadd{.
Although the model is static and optimized for 2030, we interpret the scenario variation as reflecting different sequences of policy ambition -- that is, whether hydrogen exports or domestic decarbonization are prioritized earlier on the pathway toward shared long-term goals. For instance, a scenario with high exports and low }\co \DIFadd{mitigation can reflect a pathway where export infrastructure is deployed early, with decarbonization following later and vice versa.
To explore this sequencing, we group }\DIFaddend scenarios into three illustrative \DIFdelbegin \DIFdel{mitigation-export pathways presenting various speeds of transformation. They consist of 
}\DIFdelend \DIFaddbegin \DIFadd{transition strategies: 
}\DIFaddend (i) Quick exports and slow \co mitigation,
...
\DIFaddbegin \DIFadd{These groupings help illustrate the impacts of temporal hydrogen regulation on e.g. domestic electricity cost, even within a static modeling framework.
}\DIFaddend 

%%% BRIDGE TO FIGURE
Figure \ref{fig:expenses-relative-120} shows the relative change of electricity and hydrogen cost of all mitigation-export scenarios (grouped by \DIFdelbegin \DIFdel{speed of transformation}\DIFdelend \DIFaddbegin \DIFadd{transition strategy}\DIFaddend ) in dependence of temporal matching. 
%%% FIGURE DESCRIPTION
% Quick export
The effects of temporal hydrogen regulation \DIFaddbegin \DIFadd{on market-based }\DIFaddend costs for domestic electricity consumers are most dominant in the group of Quick exports and slow \co mitigation.
...
Hourly matching reduces the \DIFdelbegin \DIFdel{cost }\DIFdelend \DIFaddbegin \DIFadd{market-based costs }\DIFaddend for domestic electricity consumers by up to -31\% (s. Fig. \ref{fig:expenses-relative-120-elec}). In only two single mitigation-export scenarios the annual or monthly matching decreases the cost for domestic electricity, whereas all other combinations of the Balanced exports and \co mitigation group are only sensitive to the strictest -- hourly matching -- hydrogen regulation. 
The cost increase for hydrogen exporters (s. Fig. \ref{fig:expenses-relative-120-hy}) is minimal, the median of the Balanced exports and \co mitigation scenarios indicates a 1\% increase.
...
% Slow exports
In the Slow exports and quick \co mitigation group, only the hourly matching has observable effects, since the electricity system is already dominated by renewable electricity and only hourly matching phases out the remaining fossil generation. Therefore, the impacts on the \DIFdelbegin \DIFdel{cost }\DIFdelend \DIFaddbegin \DIFadd{market-based costs }\DIFaddend for domestic electricity consumers (up to -11\%) and hydrogen exporters (up to 8\%) are moderate.
...
\DIFaddbegin \DIFadd{As outlined in }\nameref{sec:results}\DIFadd{, we use static scenarios to reflect different sequences of policy ambition toward shared long-term goals.
}\DIFaddend 
...
Instead, we assume a central planner’s perspective\DIFdelbegin \DIFdel{based on economic theory, where market outcomes are derived under the assumption of complete and competitive markets.
}\DIFdelend \DIFaddbegin \DIFadd{.
%DIF >  based on economic theory, where market outcomes are derived under the assumption of complete and competitive markets. 
}\DIFaddend In a perfectly competitive market with perfect information, free entry and exit, many participants, and no transaction costs or market failures, the equilibrium reached by price-taking firms and utility-maximizing consumers coincides with the solution a benevolent central planner would choose to minimize total system costs. This is consistent with the First Fundamental Welfare Theorem \cite{Feldman2017, Tan2022}.
...
and a system overview is provided in Supplementary Fig. \ref{fig:system-overview}.
...
(v) agriculture
are integrated in the sector coupled energy model, including the energy carriers electricity, hydrogen, natural gas, biomass, oil, and heat, as well as carbon dioxide in the form of emissions and feed-stock for the synthesis of other carriers (see Supplementary Fig. \ref{fig:carbon-mgmt}). 
The domestic energy services per sector remain constant throughout the scenarios presented in the \nameref{sec:intro}, regardless of endogenous hydrogen export volumes or national carbon emission reductions. However, while energy services (e.g., demand for transportation or heating) are fixed, the primary and final energy consumption are subject to \co mitigation targets. To reflect the impact of increasing shares of BEVs in the Moroccan energy system, the share of BEVs is linked to emission reduction ambitions (see Supplementary Fig. \ref{fig:bev_diffusion}) from 2\% (today's levels) up to a share of 88\% at 100\% domestic \co mitigation in accordance with Rim et al.\cite{Rim2021}.
In the case of low domestic \co mitigation, a low BEV share results in a high fuel demand for e.g. Internal Combustion Engine Cars, as observable in Supplementary Fig. \ref{fig:tsc-120-0}. This reflects a constant energy service demand (transportation) while the primary energy is subject to \co mitigation.
...
Atlite obtains technology-specific time series of the weather year 2013 based on the ERA5 reanalysis data \cite{Hersbach2020}, displayed in Supplementary Fig. \ref{fig:ren-cfs}. In addition to the time series, Atlite calculates land availabilities and linked potentials using the Copernicus Global Land Service \cite{Buchhorn2020}.
...
A key constraint on the model is that the hydrogen exported from Morocco requires to meet sustainability criteria ("green" hydrogen). A variety of studies looks into various dimensions (temporal, geographical, electricity origin) of green hydrogen and their trade-offs \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\cite{Brauer2022, Ruhnau2022, Zeyen2024}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{Brauer2022, Ruhnau2023, Zeyen2024}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend .
...
The amount of hydrogen to be exported or further synthesized for export is  implemented as an exogenous parameter in the range of 0-120~TWh/a, with sensitivity analysis up to 200 TWh/a presented in the Supplementary Discussion 3: High export sensitivity.
...
%DIFDELCMD <     \centering
%DIFDELCMD <     \includegraphics[width=0.7\linewidth]{../results/graphics_general/policy/mar_hydrogen_strategy_semistacked.pdf}
%DIFDELCMD <     %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD <     \centering
%DIFDELCMD <     \includegraphics[width=0.7\linewidth]{../results/graphics_general/morocco_em.pdf}
%DIFDELCMD <     %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
\DIFdelFL{\ (unconditional)\mbox{%DIFAUXCMD
...
%DIFDELCMD <         \centering
%DIFDELCMD <         \includegraphics[trim={0cm 0cm 0cm 1cm}, clip, width=\linewidth]{../workflow/subworkflows/pypsa-earth-sec/results/decr_13_3H_ws/0exp-only/120/graphs/balances-AC.pdf}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Fixed (1 TWh) export and 0--100\% domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation}}
        %DIFAUXCMD
...
%DIFDELCMD <     \begin{subfigure}[b]{0.49\linewidth}
%DIFDELCMD <         \centering
%DIFDELCMD <         \includegraphics[trim={0cm 0cm 0cm 1cm}, clip, width=\linewidth]{../workflow/subworkflows/pypsa-earth-sec/results/decr_13_3H_ws/co2l20-only/120/graphs/balances-AC.pdf}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Fixed (0\%) domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation and 1--120 TWh/a export}}
        %DIFAUXCMD
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Electricity supply and demand at fixed export levels and increasing domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation (\ref{fig:balances-ac-0exp-120}) and vice versa (\ref{fig:balances-ac-co2l20-120}) with hourly temporal hydrogen regulation. Increasing domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation first phases out carbon-intensive coal generation in favor of combined-cycle gas turbines (CCGT), at medium to high domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation the electricity system is fully renewable supported by flexibility through Vehicle-to-Grid (V2G) and sector coupling. Increasing electricity demands include Battery Electric Vehicles (BEV) and hydrogen (}%DIFDELCMD < {%%%
\DIFdelFL{H${}_2$}%DIFDELCMD < {}}%%%
\DIFdelFL{) generation for other sectors.
    ...
    See Supplementary Fig. \ref{fig:balances-ac-noreg} for electricity supply and demand if no hydrogen regulation is in place and Supplementary Fig. \ref{fig:balances-ac-200} for hydrogen exports up to 200 TWh/a.
    }}
    %DIFAUXCMD
...
%DIFDELCMD <     \begin{subfigure}[b]{0.49\linewidth}
%DIFDELCMD <         \centering
%DIFDELCMD <         \includegraphics[width=\linewidth]{../results/decr_13_3H_ws/graphics/integrated_comp/contour_exp_AC_exclu_H2 El_all_20_filterTrue_nTrue_exp120.pdf}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Impact of hydrogen exports on domestic interests:        
...
%DIFDELCMD <     \begin{subfigure}[b]{0.49\linewidth}
%DIFDELCMD <         \centering
%DIFDELCMD <         \includegraphics[width=\linewidth]{../results/decr_13_3H_ws/graphics/integrated_comp/contour_exp_H2_False_False_exportonly_20_filterTrue_nTrue_exp120.pdf}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Impact of domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation on hydrogen exporter interests:   
        Relative cost of hydrogen for exporters (normalized to 0\% domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation)}}
        %DIFAUXCMD
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{The effects of hydrogen exports on domestic electricity consumers and domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation on hydrogen exporters.
    Figure \ref{fig:expense_ac_120} shows the effect of hydrogen (}%DIFDELCMD < {%%%
\DIFdelFL{H${}_2$}%DIFDELCMD < {}}%%%
\DIFdelFL{) exports on domestic electricity cost with hourly hydrogen regulation. Therefore, the effect of hydrogen exports is isolated by normalizing the costs to 1 TWh/a hydrogen export in each column. This approach allows for a vertical interpretation in Figure \ref{fig:expense_ac_120} only, displaying the effects of hydrogen exports (vertical) at a certain domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation level.
    Figure \ref{fig:expense_h2_120} shows the effect of domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation on hydrogen export cost with hourly hydrogen regulation. Therefore, the effect of domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation is isolated by normalizing the costs to 0\% }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation in each row. This approach allows for a horizontal interpretation in Figure \ref{fig:expense_h2_120} only, displaying the effects of domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation (horizontal) at a certain hydrogen export quantity.
    Domestic electricity consumers profit from increasing hydrogen exports, especially at low domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation and high exports. Hydrogen exporters profit from domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation at medium mitigation efforts.
    See Supplementary Fig. \ref{fig:expenses_abs_120} for absolute cost for domestic electricity consumers and hydrogen exporters, Supplementary Fig. \ref{fig:expenses_default_120-noreg} for the interplay of hydrogen exports and domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation if no hydrogen regulation is in place and Supplementary Fig. \ref{fig:expenses_default_200} for hydrogen exports up to 200 TWh/a.
    }}
    %DIFAUXCMD
...
%DIFDELCMD < \begin{figure}[h!]
%DIFDELCMD <     \centering
%DIFDELCMD <     \includegraphics[trim={0cm 0cm 0cm 0.65cm}, clip, width=0.7\linewidth]{../results/gh/price_sorted_AC_120_2.0_Hours.pdf}
%DIFDELCMD <     %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{The effect of temporal hydrogen regulation on electricity prices.
    Figure \ref{fig:pdc-120-0} shows the price duration curve at 120 TWh/a export and 0\% domestic }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation. Stricter temporal hydrogen regulation pushes the price duration curve towards the left, as additional renewable electricity capacities phase out fossil generation with higher short-term marginal costs than renewables. Negative prices below -50 €/MWh are cut off.}}
    %DIFAUXCMD
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{The effect of temporal hydrogen regulation on the electricity system and consumer costs.
    Figure \ref{fig:expenses_rule} shows the electricity dispatch and demand (\ref{fig:dispatch_rule}) and cost for consumers (\ref{fig:expense_h2ac}) for various (hydrogen) temporal matching regimes in the 120 TWh/a export and 0\% }%DIFDELCMD < \co %%%
\DIFdelFL{mitigation scenario. Stricter temporal matching decreases carbon-intensive electricity generation (coal \& gas) for hydrogen generation and even domestic electricity consumers (s. Fig. \ref{fig:dispatch_rule}). Cost for export hydrogen generation increase to fulfill the temporal matching constraint, whereas domestic electricity consumers profit from stricter hydrogen regulation (s. Fig. \ref{fig:expense_h2ac}).}}
    %DIFAUXCMD
...
%DIFDELCMD <     \begin{subfigure}[b]{0.49\linewidth}
%DIFDELCMD <         \centering
%DIFDELCMD <         \includegraphics[trim={0cm 0cm 0cm 0cm}, clip, width=\linewidth]{../results/gh/rel_multiple_120exp_violin_elec.pdf}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Cost reduction for electricity consumers}}
        %DIFAUXCMD
%DIFDELCMD < \label{fig:expenses-relative-120-elec}
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     \hfill
%DIFDELCMD <     \begin{subfigure}[b]{0.49\linewidth}
%DIFDELCMD <         \centering
%DIFDELCMD <         \includegraphics[trim={0cm 0cm 0cm 0cm}, clip, width=\linewidth]{../results/gh/rel_multiple_120exp_violin_hy.pdf}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Cost increase for hydrogen exporters}}
        %DIFAUXCMD
%DIFDELCMD < \label{fig:expenses-relative-120-hy}
%DIFDELCMD <     \end{subfigure}
%DIFDELCMD <     \hfill    
%DIFDELCMD <     %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Relative change of electricity (s. Fig. \ref{fig:expenses-relative-120-elec}) and hydrogen consumer cost (s. Fig. \ref{fig:expenses-relative-120-hy}) depending on the temporal hydrogen regulation.     
    ...
    Domestic electricity consumers profit across all export and mitigation scenarios but most in the group of slow export and quick }%DIFDELCMD < \co %%%
...
\DIFdelFL{H${}_2$}%DIFDELCMD < {}}%%%
\DIFdelFL{) regulation regulates the welfare distribution between both groups. See Supplementary Fig. \ref{fig:expenses-relative-200} for the sensitivity of the export quantities and Supplementary Fig. \ref{fig:scenario-sel} for scenario grouping.}}
    %DIFAUXCMD
%DIFDELCMD < \label{fig:expenses-relative-120}
%DIFDELCMD < \end{figure}
%DIFDELCMD < 

%DIFDELCMD < \begin{figure*}[h!]
%DIFDELCMD <     \centering
%DIFDELCMD <     \includegraphics[width=0.7\linewidth]{../results/graphics_general/brownfield_capacities.pdf}
%DIFDELCMD <     %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdelFL{Current capacities of electricity generation and distribution in Morocco. Morocco's electricity generation portfolio is currently dominated by fossil generation (coal and gas), includes some hydropower plants and increasing but still minor capacities of onshore wind and solar PV. The data is obtained from Parzen et al.\mbox{%DIFAUXCMD
...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        ...
        \caption{\DIFaddFL{Impact of hydrogen exports on domestic interests:        
        Relative cost of electricity for domestic consumers (normalized to 1 TWh/a hydrogen export)}}
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        ...
        \caption{
        \DIFaddFL{Impact of domestic }\co \DIFaddFL{mitigation on hydrogen exporter interests:   
        Relative cost of hydrogen for exporters (normalized to 0\% domestic }\co \DIFaddFL{mitigation)}}
    ...
    See Supplementary Fig. \ref{fig:expenses_abs_120} for absolute market-based costs for domestic electricity consumers and hydrogen exporters, Supplementary Fig. \ref{fig:expenses_default_120-noreg} for the interplay of hydrogen exports and domestic }\co \DIFaddFL{mitigation if no hydrogen regulation is in place and Supplementary Fig. \ref{fig:expenses_default_200} for hydrogen exports up to 200 TWh/a.
    }}
...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        ...
        \caption{\DIFaddFL{Market-based costs for domestic electricity consumers and hydrogen exporters}}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        ...
        \caption{\DIFaddFL{Cost reduction for electricity consumers}}
